    ...
    <div className="m-auto">
      ...
      <div className="relative max-w-screen-2xl w-[100vw] sm:w-[95vw] justify-between mx-auto pt-12 md:pt-16">
        ...
        <footer className="px-5 sm:pr-0 sm:pl-0">
          <div className="flex">
            <Link href="/submit" className={`m-auto hover:${theme.textColorPrimary} p-2 hover:underline transition-all hover:${theme.hoverColor} cursor-pointer flex ${theme.textColorSecondary} text-base gap-3 my-auto`}>Submit a Server</Link>
          </div>
