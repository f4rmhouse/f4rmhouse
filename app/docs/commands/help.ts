...
- #ads Generate an ad for a showcase. It should contain 3 phones in a line with the words: step 1 step 2 step 3 below. The phones should have a green screen so that I can replace the content on the phones with my own screenshots. Bright yellow background.
- #shopping Pick out some nice japanese selvedge jeans for a night out.
