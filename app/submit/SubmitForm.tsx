...
export default function SubmitForm() {
  ...
  return (
    ...
    <form className="w-full gap-2 flex flex-col" onSubmit={handleSubmit}>
      <h1 className={`text-2xl ${theme.textColorPrimary}`}>Submit an MCP server</h1>
      <p className={`text-sm ${theme.textColorPrimary}`}>
      ...
      <label htmlFor="mcpUrl" className={`text-sm ${theme.textColorPrimary}`}>URL*</label>
      <input 
        ...
        required
      />
      <label htmlFor="creator" className={`text-sm ${theme.textColorPrimary}`}>Creator*</label>
      <input 
        className="w-full text-sm p-1 text-black" 
        type="text" 
        placeholder="Creator"
        ...
        required
      />
      <p className={`text-xs ${theme.textColorPrimary}`}>If you are the creator enter your own email</p>
      <label htmlFor="description" className={`text-sm ${theme.textColorPrimary}`}>Description (optional)</label>
      <textarea
        className="w-full text-sm p-1 text-black"
      ...
      />
      <label htmlFor="email" className={`text-sm ${theme.textColorPrimary}`}>Email*</label>
      <input 
        className="w-full text-sm p-1 text-black" 
        type="email" 
        ...
        required
      />
      <label htmlFor="rewards" className={`text-sm ${theme.textColorPrimary}`}>Payment information (pick one)</label>
      <div className="flex gap-2">
        <button 
          type="button"
          className={`p-1 w-1/2 flex ${theme.textColorPrimary} ${paymentMethod === 'paypal' ? 'underline' : 'hover:underline'}`}
        ...
        <button 
          type="button"
          className={`p-1 w-1/2 flex ${theme.textColorPrimary} ${paymentMethod === 'crypto' ? 'underline' : 'hover:underline'}`}
