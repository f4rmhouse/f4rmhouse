...
// copied from: https://tremor.so/docs/visualizations/category-bar

/**
 * CategoryBar is used to show distribution of costs divided into sections
 * of different colors with the size of a segment proportional to the total
