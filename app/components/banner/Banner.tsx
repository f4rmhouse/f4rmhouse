...
export default function Banner() {
  ...
  const pages = [
    {"deploymentType": "na", "deployed":false,"uti": "", "link": "", "id": "0", "price": "0.0", "disclaimer": "", "type": "simple", "title": "WELCOME TO THE ACTION STORE!", "description": "Super-charge your work with any MCP server connected to any LLM you want!", "decorator": "https://f4-public.s3.eu-central-1.amazonaws.com/public/assets/banner_item-1.webp", "style": ""},
    ...
    {"deploymentType": "na", "deployed":false,"uti": "", "link": "", "id": "3", "price": "0.0", "disclaimer": "", "type": "central-text", "title": "1. Developers create MCPs.", "description": "", "decorator": "", "style": ""},
    {"deploymentType": "na", "deployed":false,"uti": "", "link": "", "id": "8", "price": "0.0", "disclaimer": "", "type": "central-text", "title": "2. You connect MCP to an LLM.", "description": "", "decorator": "", "style": "font-arial text-black text-5xl bg-yellow-400"},
